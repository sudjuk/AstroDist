...
```bash
# Frontend
git clone https://github.com/sudjuk/AstroDist-Frontend.git

# Backend
git clone https://github.com/sudjuk/AstroDist-Backend.git

# Async Service
git clone https://github.com/sudjuk/AstroDist-async-service.git
